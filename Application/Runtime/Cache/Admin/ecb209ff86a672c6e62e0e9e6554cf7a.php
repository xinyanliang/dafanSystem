			...
			<li><a href="<?php echo U('Download/download');?>">相关文件下载</a></li>
				...
				<div class="main">
					<div class="shadow1 center main11">
						 <p class="tianjiaa selfa">下载区域</p>
					</div>
					<div  class="shadow1 center main2">
						<ol style="padding-top:20px;padding-left:40px">
							<li style="padding-top:20px;color:#56abe4"><a href="/Public/Admin/pro.csv" style="color:#56abe4">项目信息.csv <img src="/Public/Admin/image/xiazai.png" style="padding-left:100px;text-align:center"></a></li>
							<li style="padding-top:20px;color:#56abe4"><a href="/Public/Admin/student.csv" style="color:#56abe4">学生信息.csv <img src="/Public/Admin/image/xiazai.png" style="padding-left:100px;text-align:center"></a></li>
						</ol>
					</div>
			</div>
			<div class="clear"></div>

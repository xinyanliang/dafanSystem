			...
			<li><a href="<?php echo U('Download/download');?>">相关文件下载</a></li>
				...
				<div class="main">
					<div class="shadow1 center main1">
						...
						<a href="<?php echo U('Project/findby_gradeandgroup');?>" class="tianjiaa selfb">年级组号查询</a>
						<form action="<?php echo U('findby_proname');?>" method="post" class="font12">
							名称查询：<input name="proname" style="margin-left:10px"><input type="submit">
						</form>
					</div>
					...
					<div  class="shadow1 center main22">
						  <table width="70%"  border=1 cellspacing=0 bordercolor="#ccc" class="table_tr20">
							...
							<?php if(is_array($projectData)): foreach($projectData as $key=>$vo): ?><tr   align="middle">
								...
								<tr><td colspan="8"><a class="selectAll" style="curser="pointer"">全选</a> <a class="cancelAll">取消</a><a class="reverse">反选</a></td></td></tr>
						  </table>
					</div><?php endif; ?>
			</div>
			<div class="clear"></div>

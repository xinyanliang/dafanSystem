			...
			<li><a href="<?php echo U('Download/download');?>">相关文件下载</a></li>
				...
				<div class="main">
					<div  class="shadow1 center main3" >
					    <form action="<?php echo U('delete_project');?>" method="post">
						  <table width="70%"  border=1 cellspacing=0 bordercolor="#ccc" class="table_tr20">
							<tr   align="middle"><th>组号</th><th>项目名称</th><th>分数</th><th>打分总人数</th><th>已打分人数</th></tr>
							<?php if(is_array($scoreData)): foreach($scoreData as $key=>$vo): ?><tr   align="middle">
									...
									<td><?php echo ($vo['peoplenums']); ?></td>
									<td><?php echo ($vo['count_people']); ?></td>

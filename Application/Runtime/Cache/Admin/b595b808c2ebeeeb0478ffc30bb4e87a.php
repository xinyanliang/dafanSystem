		...
		<div class="login">
			<form action="<?php echo U('index');?>" method="post" name="myform" class="font12" style="width:280px;color:#0055f0">
			    <fieldset style="padding:20px 30px;" class=" border1 ">
					<legend style="font-size:20px;color:#0055f0">教师登陆</legend>
					工  号：<input name="user_id" style="margin-left:10px;border:2px solid #0055f0;padding-left:5px;outline:none;" class="radius8"><br/>
					<p class="magtop5"></p>
